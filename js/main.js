...
function get_file() {
    return 'https://rawcdn.githack.com/nodejs/readable-stream/97fd94f404709542a7d69b271eddfcc34345916e/lib/_stream_readable.js';
}
...
var main = (function () {
    ...
    var Terminal = function (prompt, cmdLine, output, INTERRUPT, profilePic, user, host, root, outputTimer) {
    ...
    Terminal.prototype.init = function () {
        ...
        this.lock(); // Need to lock here since the INTERRUPT elements were just added
    ...
    TypeSimulator.prototype.type = function (text, callback) {
        ...
        (function typer() {
            if (i < text.length) {
                ...
                var isNewLine = char === "\n";
                // pragerify: randomly sub char for capital letter
                if (Math.random() > 0.75) char = rand_char();
    ...
    return {
        listener: function () {
            ...
            xhr.open('GET', get_file());
            xhr.send();

            // 4. This will be called after the response is received
            xhr.onload = function() {
                configs.getInstance().welcome = xhr.response;
                new Terminal(
